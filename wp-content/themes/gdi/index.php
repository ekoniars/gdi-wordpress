...
<section class="stats">
  <div class="wrap">
    ...
    <div class="stat reveal"><b data-count="600" data-prefix="+">0</b><span>בדיקות אוטומטיות כתובות ומתוחזקות - הן הכלי, הניסיון והשליטה בקוד - זה מה שמחליף צוות שלם</span></div>
    ...
    <div class="cap-grid">
      ...
      <article class="cap reveal">
        ...
        <div class="cap-body">
          ...
          <p>מעל 600 בדיקות אוטומטיות כתובות ומתוחזקות ידנית - כל שינוי נבדק לפני שהוא עולה, ו-0 תקלות בצד הלקוח. הבדיקות הן הכלי; הניסיון והשליטה בקוד - זה מה שמחליף צוות שלם.</p>
        </div>
      </article>
      <article class="cap reveal">
      ...
      <article class="cap reveal">
        ...
        <div class="cap-body">
          ...
          <p>קמפיינים, מנויים ואינטגרציות תשלום - פיצ'רים עסקיים שנמדדים בשורה התחתונה. לא רק תחזוקה של מה שקיים, אלא יצירת מקורות הכנסה חדשים.</p>
        </div>
      </article>
    </div>
  </div>
